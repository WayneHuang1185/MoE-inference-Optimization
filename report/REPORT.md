...
![GPU baseline total latency](../experiments/gpu_main_rpp_gpu/figures/gpu_all_baseline_total_latency.png)

![GPU baseline throughput](../experiments/gpu_main_rpp_gpu/figures/gpu_all_baseline_throughput.png)
...
![RPP GPU vs no-RPP total latency](../experiments/gpu_main_rpp_gpu/figures/phase2_gpu_rpp_vs_no_rpp_total_latency.png)
...
![Oracle H2D reduction](../experiments/gpu_main_rpp_gpu/figures/oracle_vs_baseline_h2d_reduction.png)
...
![Real RPP prediction recall](../experiments/gpu_main_rpp_gpu/figures/real_rpp_prediction_recall_4gb.png)
...
![Runtime cache H2D reduction](../experiments/gpu_main_rpp_gpu/figures/final_phase4_cache_h2d_reduction.png)
...
![Phase 5 hint H2D delta](../experiments/gpu_main_rpp_gpu/figures/final_phase5_hint_h2d_delta.png)
...
![Final Phase 6 latency vs baseline](../experiments/gpu_main_rpp_gpu/figures/final_phase6_latency_vs_baseline.png)

![Final Phase 6 throughput vs baseline](../experiments/gpu_main_rpp_gpu/figures/final_phase6_throughput_vs_baseline.png)

![Final Phase 6 H2D vs baseline](../experiments/gpu_main_rpp_gpu/figures/final_phase6_total_h2d_vs_baseline.png)

![Final Phase 6 hit rate vs ready-hit](../experiments/gpu_main_rpp_gpu/figures/final_phase6_hit_rate_vs_ready_hit.png)
...
| 圖 | 路徑 |
|---|---|
| GPU baseline latency | `../experiments/gpu_main_rpp_gpu/figures/gpu_all_baseline_total_latency.png` |
| GPU baseline throughput | `../experiments/gpu_main_rpp_gpu/figures/gpu_all_baseline_throughput.png` |
| RPP vs no-RPP latency | `../experiments/gpu_main_rpp_gpu/figures/phase2_gpu_rpp_vs_no_rpp_total_latency.png` |
| Oracle H2D reduction | `../experiments/gpu_main_rpp_gpu/figures/oracle_vs_baseline_h2d_reduction.png` |
| Real RPP recall | `../experiments/gpu_main_rpp_gpu/figures/real_rpp_prediction_recall_4gb.png` |
| Runtime cache H2D | `../experiments/gpu_main_rpp_gpu/figures/final_phase4_cache_h2d_reduction.png` |
| Phase 5 H2D delta | `../experiments/gpu_main_rpp_gpu/figures/final_phase5_hint_h2d_delta.png` |
| Phase 6 latency | `../experiments/gpu_main_rpp_gpu/figures/final_phase6_latency_vs_baseline.png` |
| Phase 6 throughput | `../experiments/gpu_main_rpp_gpu/figures/final_phase6_throughput_vs_baseline.png` |
| Phase 6 H2D | `../experiments/gpu_main_rpp_gpu/figures/final_phase6_total_h2d_vs_baseline.png` |
| Phase 6 hit rate | `../experiments/gpu_main_rpp_gpu/figures/final_phase6_hit_rate_vs_ready_hit.png` |
...
|---|---|
| 完整報告 | `report.md` |
| RPP-GPU README | `experience/RPP-GPU/README.md` |
| RPP d64 training report | `../experiments/gpu_main_rpp_gpu/results/rpp_train_d64/REPORT.md` |
| CPU/GPU baseline results | `../experiments/gpu_main_rpp_gpu/results/rpp_analyze/` |
| Oracle comparison | `../experiments/gpu_main_rpp_gpu/results/oracle_hints/oracle_vs_baseline_comparison.md` |
| Offline real-RPP | `../experiments/gpu_main_rpp_gpu/results/real_rpp_offline/real_rpp_first_token_offline_formal_0625_2251.summary.md` |
| Runtime cache formal | `../experiments/gpu_main_rpp_gpu/results/phase4_runtime_cache_formal_comparison.md` |
| Runtime RPP hint smoke | `../experiments/gpu_main_rpp_gpu/results/phase5_runtime_rpp_hint_smoke_comparison.md` |
| Online RPP-GPU formal | `../experiments/gpu_main_rpp_gpu/results/phase6_qwen_online_rpp_gpu_formal_0626_1441.summary.md` |
| Final comparison | `../experiments/gpu_main_rpp_gpu/results/final_runtime_comparison_0626.md` |
