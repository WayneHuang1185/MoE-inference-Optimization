        ...
        while (std::getline(input, line)) {
            ...
            try {
                ...
                if (columns.count("component") != 0 && columns.count("kind") != 0) {
                    ...
                    } else if (component_name == "ffn_gate_exps" && kind == "weight") {
                        component = llama_rpp_expert_component::gate_weight;
                    } else if (component_name == "ffn_up_exps" && kind == "weight") {
                        component = llama_rpp_expert_component::up_weight;
