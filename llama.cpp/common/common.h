...
struct common_params_rpp {
    std::string mode = "off";
    std::string predictions;
    std::string trace;
    std::string page_map;
    std::string host_prefetch = "off";
    std::string gpu_transfer = "off";
    std::string gpu_correction = "off";
    std::string gpu_compute = "off";
    std::string sidecar_url = "http://127.0.0.1:18081";

    int32_t prefetch_depth = 0;
    int32_t prefetch_top_k = 8;
    std::string prefetch_admission = "topk";
    int32_t feo_min_count = 1;
    int32_t feo_max_experts = 0;
    float feo_density_threshold = 0.0f;
    int32_t prefetch_threads = 1;
    int32_t gpu_cache_mib = 256;
    int32_t gpu_staging_mib = 64;
    int32_t gpu_copy_workers = 1;
    std::string gpu_queue_policy = "fifo";
    std::string gpu_reclaim_policy = "lru";
    int32_t sidecar_timeout_ms = 30000;
