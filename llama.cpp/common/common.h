...
struct common_params {
    ...
    // RPP live experiment knobs. Default scheduler is disabled/no-op.
    std::string rpp_scheduler                = "none";
    std::string rpp_live_model               = "";
    std::string rpp_tensor_ranges            = "";
    std::string rpp_oracle_trace             = "";
    std::string rpp_reclaim_mode             = "trace-priority";
    int32_t     rpp_max_decode_slots         = 0;
    int32_t     rpp_window_size              = 10;
    int32_t     rpp_prefetch_count_threshold = 5;
    int32_t     rpp_predict_topk             = 8;
    int32_t     rpp_predictor_threads        = 1;
    std::string rpp_predictor_cpu_mask       = "";
    float       rpp_cache_threshold          = 0.0f;
    int32_t     rpp_page_stride              = 1;
