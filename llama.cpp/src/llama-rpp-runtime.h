...
private:
    ...
    void schedule_prefetch(
            ...
            int32_t layer);
    void schedule_ubatch_prefetch(int32_t layer);
    std::vector<int32_t> feo_admitted_experts(int32_t layer) const;
    void update_reclaim_hints(int32_t current_layer);
    ...
    std::string prefetch_admission_ = "topk";
    std::string gpu_reclaim_policy_ = "lru";
    int32_t feo_min_count_ = 1;
    int32_t feo_max_experts_ = 0;
    float feo_density_threshold_ = 0.0f;
