...
enum class llama_rpp_gpu_reclaim_policy {
    lru,
    feo,
};
...
private:
    ...
    llama_rpp_gpu_reclaim_policy reclaim_policy_ = llama_rpp_gpu_reclaim_policy::lru;
    ...
    std::map<llama_rpp_expert_key, double> reclaim_hints_;
    std::map<
