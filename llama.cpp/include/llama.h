...
#define LLAMA_STATE_SEQ_FLAGS_ON_DEVICE 2
    ...
    struct llama_rpp_config {
        ...
        const char * prefetch_admission; // "topk" or "feo"
        int32_t feo_min_count;
        int32_t feo_max_experts;         // 0 means unlimited
        float   feo_density_threshold;
        ...
        const char * gpu_reclaim_policy; // "lru" or "feo"
